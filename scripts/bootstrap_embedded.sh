...
echo "       ./scripts/rehearse_first_governed_cell.sh"
echo ""
...
echo "       See profiles/ for opinionated configurations (solo, builder, team, institution)."
echo ""
echo "  4. Run the full rehearsal suite:"
echo "       ./scripts/rehearse_setup.sh"
echo ""
