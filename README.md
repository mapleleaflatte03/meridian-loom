...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.1.1-0c1117?style=flat-square" alt="Version 0.1.1">
</p>
...
Meridian Loom is the primary hands-on product surface for Meridian v0.1.1. It carries the Meridian installer and CLI, provisions into the operator's home directory, and exposes the bounded execution primitives that operators can install, inspect, and run directly.
